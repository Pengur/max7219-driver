...
#define FONT_WIDTH 5
#define FONT_FIRST 48
#define FONT_LAST 90

static const uint8_t font_default[][FONT_WIDTH] = {
    // ai generated
    /* 0x30 '0' */ {0x3E, 0x51, 0x49, 0x45, 0x3E},
    /* 0x31 '1' */ {0x00, 0x42, 0x7F, 0x40, 0x00},
    /* 0x32 '2' */ {0x42, 0x61, 0x51, 0x49, 0x46},
    /* 0x33 '3' */ {0x22, 0x41, 0x49, 0x49, 0x36},
...
const font_t font_def = {.first_char = FONT_FIRST,
                         .last_char = FONT_LAST,
                         .width = FONT_WIDTH,
                         .height = FONT_HEIGHT,
                         .font_array = &font_default[0][0]};
